# 1 "c:\\users\\demo\\documents\\scripts\\lr-vugen-sap-sapgui-s4hana-va01\\\\combined_s4hana-va01-create-sales-order.c"
...
# 1 "c:\\users\\demo\\documents\\scripts\\lr-vugen-sap-sapgui-s4hana-va01\\\\combined_s4hana-va01-create-sales-order.c" 2
...
# 2 "c:\\users\\demo\\documents\\scripts\\lr-vugen-sap-sapgui-s4hana-va01\\\\combined_s4hana-va01-create-sales-order.c" 2
...
const char* ctxtVBAK2=
		"usr/ctxtVBAK-VTWEG";

const char* ctxtVBAK3=
		"usr/ctxtVBAK-SPART";

const char* txtVBKD1=
		"usr/subSUBSCREEN_HEADER:SAPMV45A:4021/txtVBKD-BSTKD";

const char* ctxtKUAGV1=
		"usr/subSUBSCREEN_HEADER:SAPMV45A:4021/subPART-SUB:SAPMV45A:4701/ctxtKUAGV-KUNNR";

const char* ctxtKUWEV1=
		"usr/subSUBSCREEN_HEADER:SAPMV45A:4021/subPART-SUB:SAPMV45A:4701/ctxtKUWEV-KUNNR";

const char* ctxtVBKD1=
		"usr/subSUBSCREEN_HEADER:SAPMV45A:4021/ctxtVBKD-BSTDK";

const char* shell1=
		"usr/cntlCONTAINER/shellcont/shell";

const char* tblSAPMV45ATCTRL_U_ERF_AUFTRAG1=
		"usr/tabsTAXI_TABSTRIP_OVERVIEW/tabpT\\01/ssubSUBSCREEN_BODY:SAPMV45A:4400/"
		"subSUBSCREEN_TC:SAPMV45A:4900/tblSAPMV45ATCTRL_U_ERF_AUFTRAG";
...
const char* originalid1=
		"OriginalID=usr/tabsTAXI_TABSTRIP_OVERVIEW/tabpT\\01/"
		"ssubSUBSCREEN_BODY:SAPMV45A:4400/subSUBSCREEN_TC:SAPMV45A:4900/"
		"tblSAPMV45ATCTRL_U_ERF_AUFTRAG/ctxtVBAP-VRKME[4,0]";
...
# 3 "c:\\users\\demo\\documents\\scripts\\lr-vugen-sap-sapgui-s4hana-va01\\\\combined_s4hana-va01-create-sales-order.c" 2
...
vuser_init()
{
	...
	lr_end_transaction("001_SAP_Logon",2);

	lr_think_time(3);

	return 0;
}
# 4 "c:\\users\\demo\\documents\\scripts\\lr-vugen-sap-sapgui-s4hana-va01\\\\combined_s4hana-va01-create-sales-order.c" 2
...
Action()
{
	...
	lr_end_transaction("002_Nav_to_va01",2);
	...
	lr_end_transaction("003_va01_screen_1",2);
	...
	lr_end_transaction("004_va01_create_order",2);
	...
	sapgui_press_button("Exit", 
		...
		"OPT_END");
	lr_end_transaction("005_va01_exit_tcode",2);
	return 0;
}
# 5 "c:\\users\\demo\\documents\\scripts\\lr-vugen-sap-sapgui-s4hana-va01\\\\combined_s4hana-va01-create-sales-order.c" 2
...
vuser_end()
{
	...
	lr_end_transaction("006_Logoff",2);

	lr_think_time(3);

	return 0;
}
# 6 "c:\\users\\demo\\documents\\scripts\\lr-vugen-sap-sapgui-s4hana-va01\\\\combined_s4hana-va01-create-sales-order.c" 2
